...
let questions = [
    { 
        ...
        answers: [
            ...
            {text: "Professional and Creative Administration: Development, Prosperity, and Good Governance", correct: true},
            {text: "Innovating the Future Public Service: New Government Models for a New Era to Reach the SDGs", correct: false},
            {text: "Respecting diversity through joint social action", correct: false}
        ],
        explanation: "A meeting of the Civil Service Day Main Programme Committee chaired by Chief Secretary Shanker Das Bairagi fixed the slogan - 'Professional and Creative administration: Development, Prosperity and Good Governance' – as the motto from 2078 BS to 2082 BS."
    }, 
    {
        question: "Which country started the use of competitive examination to select civil service officers?",
        answers: [
        ...
        explanation: "During the Han Dynasty (206 BC - 220 BC)"
    }, 
    {
        question: "Which country started the practice of merit based civil service?",
        answers: [
            {text: "India", correct: false},
            {text: "USSR", correct: false},
        ...
        explanation: "Concrete rules made in 1854 A.D. to chose administrators to ease the rule in India by the Britishers."
    }, 
